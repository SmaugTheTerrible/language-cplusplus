...
data Token
    ...
    | Punc_LeftBrace Pos
    | Punc_RightBrace Pos
    | Punc_LeftBracket Pos
    | Punc_RightBracket Pos
    | Punc_Hash Pos
    | Punc_DoubleHash Pos
    | Punc_LeftParen Pos
    | Punc_RightParen Pos
    ...
    | Punc_Colon Pos
    | Punc_ThreeDot Pos
    | Punc_QuestionMark Pos
    | Punc_DoubleColon Pos
    | Punc_Dot Pos
    | Punc_Comma Pos
    | Op_DotPtr Pos
    | Op_Plus Pos
    ...
    | Op_LeftShift Pos
    | Op_RightShift Pos
    | Op_AssignLeftShift Pos
    | Op_AssignRightShift Pos
    | Op_Eq Pos
    | Op_NotEq Pos
    | Op_LessEq Pos
    | Op_GreaterEq Pos
...
{-    | Op_LiterAnd
    ...
    | Literal_Integer Pos String
    | Literal_Char Pos String
    | Literal_String Pos String
    | Literal_Float Pos String
    | Literal_Boolean Pos String
    | Literal_NullPtr Pos String
    | Literal_UserDefined Pos String
    | Id Pos String
    | PP_If Pos
    | PP_Ifdef Pos
    | PP_Ifndef Pos
